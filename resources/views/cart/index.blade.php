    ...
    <div class="table-parent">
                ...
                @foreach (session('cart') as $id => $details)
                    ...
                    <div class="table-body" id="{{ $id }}">
                        ...
                        <div class="content-right">
                            <p>${{ $details['price'] }}</p>
                            <input class="cart-input quantity product_update" type="number"
        ...
        @else
           ...
           <div class="empty-parent">
            <div class="empty">
                <img src="/assets/empty-cart.jpg" alt="" class="emptycart">
                <p class="emptyp1">Your cart is empty</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda, dignissimos.</p>
                <button class="start-shopping" ><a href="{{route('shop.index')}}">Start shopping</a> </button>
            </div>
           </div>
